...
This outlines how to propose a change to ggmemo. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("lindsay-lintelman/ggmemo", fork = TRUE)`.
...
of
Conduct](https://lindsay-lintelman.github.io/ggmemo/CODE_OF_CONDUCT.md).
